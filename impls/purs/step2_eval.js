...
(function($PS) {
  ...
  var replEnv = Data_Map_Internal.fromFoldable(Data_Ord.ordString)(Data_Foldable.foldableArray)([ new Data_Tuple.Tuple("+", fn(Data_Semiring.add(Data_Semiring.semiringInt))), new Data_Tuple.Tuple("-", fn(Data_Ring.sub(Data_Ring.ringInt))), new Data_Tuple.Tuple("*", fn(Data_Semiring.mul(Data_Semiring.semiringInt))), new Data_Tuple.Tuple("/", fn(Data_EuclideanRing.div(Data_EuclideanRing.euclideanRingInt))) ]);
  var evalAst = function (v) {
      return function (v1) {
          if (v1 instanceof Types.MalSymbol) {
              ...
              throw new Error("Failed pattern match at Main (line 42, column 31 - line 44, column 38): " + [ v2.constructor.name ]);
          };
  ...
  var rep = function (str) {
      var v = read(str);
      if (v instanceof Data_Either.Left) {
          return Effect_Console.error("EOF");
      };
      if (v instanceof Data_Either.Right) {
          return function __do() {
              var result = Effect_Exception["try"]($$eval(replEnv)(v.value0))();
              if (result instanceof Data_Either.Right) {
                  return Control_Bind.bind(Effect.bindEffect)(print(result.value0))(Effect_Console.log)();
              };
              if (result instanceof Data_Either.Left) {
                  return Effect_Console.error(Data_Show.show(Effect_Exception.showError)(result.value0))();
              };
              throw new Error("Failed pattern match at Main (line 87, column 5 - line 89, column 36): " + [ result.constructor.name ]);
          };
      };
      throw new Error("Failed pattern match at Main (line 83, column 11 - line 89, column 36): " + [ v.constructor.name ]);
  };
