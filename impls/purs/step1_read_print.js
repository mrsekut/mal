...
(function($PS) {
  // Generated by purs version 0.14.2
  "use strict";
  $PS["Mal.Step1"] = $PS["Mal.Step1"] || {};
  var exports = $PS["Mal.Step1"];
  var Control_Bind = $PS["Control.Bind"];
  var Data_Either = $PS["Data.Either"];
  var Data_Unit = $PS["Data.Unit"];
  var Effect = $PS["Effect"];
  ...
  var rep = function (str) {
      ...
      if (v instanceof Data_Either.Right) {
          return Control_Bind.bind(Effect.bindEffect)(print($$eval(v.value0)))(Effect_Console.log);
      };
      throw new Error("Failed pattern match at Mal.Step1 (line 38, column 11 - line 40, column 36): " + [ v.constructor.name ]);
  };
