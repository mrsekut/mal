...
(function($PS) {
  ...
  // List functions
  var list = (function () {
      var $93 = Control_Applicative.pure(Effect.applicativeEffect);
      return function ($94) {
      ...
      return Control_Apply.applySecond(Effect.applyEffect)(Control_Apply.applySecond(Effect.applyEffect)(Control_Apply.applySecond(Effect.applyEffect)(Control_Apply.applySecond(Effect.applyEffect)(Data_Traversable.traverse(Data_List_Types.traversableList)(Effect.applicativeEffect)(setFn(env))(Core.ns))(setFn(env)(Data_Tuple.Tuple.create("eval")(setEval(env)))))(rep(env)("(def! not (fn* (a) (if a false true)))")))(rep(env)("(def! load-file (fn* (f) (eval (read-string (str \"(do \" (slurp f) \"\x0anil)\")))))")))((function () {
          ...
          if (Readline.args instanceof Data_List_Types.Cons) {
              return function __do() {
                  ...
                  rep(env)("(load-file \"" + (Readline.args.value0 + "\")"))();
                  return Data_Unit.unit;
              };
          };
          throw new Error("Failed pattern match at Main (line 31, column 8 - line 38, column 18): " + [ Readline.args.constructor.name ]);
      })())();
  };
  exports["main"] = main;
  exports["rep"] = rep;
