...
(function($PS) {
  ...
  var stringToCharList = (function () {
      var $62 = Data_List.fromFoldable(Data_Foldable.foldableArray);
      return function ($63) {
          return $62(Data_String_CodeUnits.toCharArray($63));
      };
  })();                                                                                                           
  var monadMalEnv = Control_Monad_Reader_Trans.monadReaderT(Effect.monadEffect);
  ...
  var eqMalExpr = new Data_Eq.Eq(function (v) {
      return function (v1) {
          ...
          if (v instanceof MalList && v1 instanceof MalList) {
              return Data_Eq.eq(Data_List_Types.eqList(eqMalExpr))(v.value0)(v1.value0);
          };
          ...
          if (v instanceof MalHashMap && v1 instanceof MalHashMap) {
              return Data_Eq.eq(Data_Map_Internal.eqMap(eqKey)(eqMalExpr))(v.value0)(v1.value0);
          };
          return false;
      };
  });
  var ordKey = new Data_Ord.Ord(function () {
      ...
      return function (y) {
          ...
          throw new Error("Failed pattern match at Types (line 56, column 1 - line 56, column 34): " + [ x.constructor.name, y.constructor.name ]);
      };
  });
  var listToMap = Data_Map_Internal.fromFoldable(ordKey)(Data_List_Types.foldableList);
  var charListToString = (function () {
      var $64 = Data_Array.fromFoldable(Data_List_Types.foldableList);
      return function ($65) {
          return Data_String_CodeUnits.fromCharArray($64($65));
      };
  })();
  ...
  exports["monadMalEnv"] = monadMalEnv;
...
(function($PS) {
  ...
  var set = function (ky) {
      return function (ex) {
          ...
          return Control_Bind.bind(Types.bindMalEnv)(Control_Monad_Reader_Class.ask(Types.monadAskMalEnv))(function (ref) {
              return Control_Bind.bind(Types.bindMalEnv)(Effect_Class.liftEffect(Types.monadEffectMalEnv)(Effect_Ref.read(ref)))(function (envs) {
                  return Effect_Class.liftEffect(Types.monadEffectMalEnv)(Effect_Ref.write(update(ky)(ex)(envs))(ref));
              });
          });
      };
  };
  var sets = function (v) {
      return function (v1) {
          if (v instanceof Data_List_Types.Nil && v1 instanceof Data_List_Types.Nil) {
              return Control_Applicative.pure(Types.applicativeMalEnv)(true);
          };
          if (v instanceof Data_List_Types.Cons && (v.value0 === "&" && (v.value1 instanceof Data_List_Types.Cons && v.value1.value1 instanceof Data_List_Types.Nil))) {
              return Control_Apply.applySecond(Types.applyMalEnv)(set(v.value1.value0)(Types.toList(v1)))(Control_Applicative.pure(Types.applicativeMalEnv)(true));
          };
          if (v instanceof Data_List_Types.Cons && v1 instanceof Data_List_Types.Cons) {
              return Control_Apply.applySecond(Types.applyMalEnv)(set(v.value0)(v1.value0))(sets(v.value1)(v1.value1));
          };
          return Control_Applicative.pure(Types.applicativeMalEnv)(false);
      };
  };
  ...
  var newEnv = Control_Bind.bind(Types.bindMalEnv)(Control_Monad_Reader_Class.ask(Types.monadAskMalEnv))(function (ref) {
      return Control_Bind.bind(Types.bindMalEnv)(Effect_Class.liftEffect(Types.monadEffectMalEnv)(Effect_Ref.read(ref)))(function (envs) {
          return Effect_Class.liftEffect(Types.monadEffectMalEnv)(Effect_Ref.write(new Data_List_Types.Cons(initEnv, envs))(ref));
      });
  });
  ...
  var deleteEnv = Control_Bind.bind(Types.bindMalEnv)(Control_Monad_Reader_Class.ask(Types.monadAskMalEnv))(function (ref) {
      return Control_Bind.bind(Types.bindMalEnv)(Effect_Class.liftEffect(Types.monadEffectMalEnv)(Effect_Ref.read(ref)))(function (envs) {
          var v = Data_List.tail(envs);
          if (v instanceof Data_Maybe.Just) {
              return Effect_Class.liftEffect(Types.monadEffectMalEnv)(Effect_Ref.write(v.value0)(ref));
          };
          if (v instanceof Data_Maybe.Nothing) {
              return Effect_Class.liftEffect(Types.monadEffectMalEnv)(Effect_Ref.write(envs)(ref));
          };
          throw new Error("Failed pattern match at Env (line 42, column 3 - line 44, column 47): " + [ v.constructor.name ]);
      });
  });
  var local = function (cb) {
      return Control_Bind.discard(Control_Bind.discardUnit)(Types.bindMalEnv)(newEnv)(function () {
          return Control_Bind.bind(Types.bindMalEnv)(cb)(function (result) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Types.bindMalEnv)(deleteEnv)(function () {
                  return Control_Applicative.pure(Types.applicativeMalEnv)(result);
              });
          });
      });
  };
...
(function($PS) {
  ...
  var Types = $PS["Types"];                
  var str = (function () {
      var $65 = Control_Applicative.pure(Types.applicativeMalEnv);
  ...
  var slurp = function (v) {
      if (v instanceof Data_List_Types.Cons && (v.value0 instanceof Types.MalString && v.value1 instanceof Data_List_Types.Nil)) {
          return Data_Functor.map(Types.functorMalEnv)(Types.MalString.create)(Effect_Class.liftEffect(Types.monadEffectMalEnv)(Node_FS_Sync.readTextFile(Node_Encoding.UTF8.value)(v.value0.value0)));
      };
      return Env.throwStr(Types.monadEffectMalEnv)("invalid arguments to slurp");
  };
  var readString = function (v) {
      if (v instanceof Data_List_Types.Cons && (v.value0 instanceof Types.MalString && v.value1 instanceof Data_List_Types.Nil)) {
          var v1 = Mal_Reader.readStr(v.value0.value0);
          if (v1 instanceof Data_Either.Left) {
              return Env.throwStr(Types.monadEffectMalEnv)("invalid read-string");
          };
          if (v1 instanceof Data_Either.Right) {
              return Control_Applicative.pure(Types.applicativeMalEnv)(v1.value0);
          };
          throw new Error("Failed pattern match at Core (line 104, column 34 - line 106, column 25): " + [ v1.constructor.name ]);
      };
      return Env.throwStr(Types.monadEffectMalEnv)("invalid read-string");
  };
  var prn = function (args) {
      return Effect_Class.liftEffect(Types.monadEffectMalEnv)(function __do() {
  ...
  var pred1 = function (v) {
      return function (v1) {
          if (v1 instanceof Data_List_Types.Cons && v1.value1 instanceof Data_List_Types.Nil) {
              return Control_Applicative.pure(Types.applicativeMalEnv)(Types.MalBoolean.create(v(v1.value0)));
          };
          return Env.throwStr(Types.monadEffectMalEnv)("illegal call to unary predicate");
      };
  };

  // String functions
  var prStr = (function () {
      var $68 = Control_Applicative.pure(Types.applicativeMalEnv);
      return function ($69) {
  ...
  var numOp = function (v) {
      return function (v1) {
          if (v1 instanceof Data_List_Types.Cons && (v1.value0 instanceof Types.MalInt && (v1.value1 instanceof Data_List_Types.Cons && (v1.value1.value0 instanceof Types.MalInt && v1.value1.value1 instanceof Data_List_Types.Nil)))) {
              return Control_Applicative.pure(Types.applicativeMalEnv)(Types.MalInt.create(v(v1.value0.value0)(v1.value1.value0.value0)));
          };
          return Env.throwStr(Types.monadEffectMalEnv)("invalid operator");
      };
  };
  var nilQ = function (v) {
      if (v instanceof Types.MalNil) {
  ...
  // List functions
  var list = (function () {
      var $70 = Control_Applicative.pure(Types.applicativeMalEnv);
      return function ($71) {
  ...
  var eqQ = function (v) {
      if (v instanceof Data_List_Types.Cons && (v.value1 instanceof Data_List_Types.Cons && v.value1.value1 instanceof Data_List_Types.Nil)) {
          return Control_Applicative.pure(Types.applicativeMalEnv)(Types.MalBoolean.create(Data_Eq.eq(Types.eqMalExpr)(v.value0)(v.value1.value0)));
      };
      return Env.throwStr(Types.monadEffectMalEnv)("illegal arguments to =");
  };
  ...
  var count = function (v) {
      if (v instanceof Data_List_Types.Cons && (v.value0 instanceof Types.MalNil && v.value1 instanceof Data_List_Types.Nil)) {
          return Control_Applicative.pure(Types.applicativeMalEnv)(new Types.MalInt(0));
      };
      if (v instanceof Data_List_Types.Cons && (v.value0 instanceof Types.MalList && v.value1 instanceof Data_List_Types.Nil)) {
          return Control_Applicative.pure(Types.applicativeMalEnv)(Types.MalInt.create(Data_List.length(v.value0.value0)));
      };
      if (v instanceof Data_List_Types.Cons && (v.value0 instanceof Types.MalVector && v.value1 instanceof Data_List_Types.Nil)) {
          return Control_Applicative.pure(Types.applicativeMalEnv)(Types.MalInt.create(Data_List.length(v.value0.value0)));
      };
      return Env.throwStr(Types.monadEffectMalEnv)("non-sequence passed to count");
  };
  var cmpOp = function (v) {
      return function (v1) {
          if (v1 instanceof Data_List_Types.Cons && (v1.value0 instanceof Types.MalInt && (v1.value1 instanceof Data_List_Types.Cons && (v1.value1.value0 instanceof Types.MalInt && v1.value1.value1 instanceof Data_List_Types.Nil)))) {
              return Control_Applicative.pure(Types.applicativeMalEnv)(Types.MalBoolean.create(v(v1.value0.value0)(v1.value1.value0.value0)));
          };
          return Env.throwStr(Types.monadEffectMalEnv)("invalid operator");
      };
  };
...
(function($PS) {
  ...
  var letBind = function (v) {
      if (v instanceof Data_List_Types.Nil) {
          return Control_Applicative.pure(Types.applicativeMalEnv)(Data_Unit.unit);
      };
      if (v instanceof Data_List_Types.Cons && (v.value0 instanceof Types.MalSymbol && v.value1 instanceof Data_List_Types.Cons)) {
          return Control_Apply.applySecond(Types.applyMalEnv)(Control_Bind.bindFlipped(Types.bindMalEnv)(Env.set(v.value0.value0))($$eval(v.value1.value0)))(letBind(v.value1.value1));
      };
      return Env.throwStr(Types.monadEffectMalEnv)("invalid let*");
  };
  var evalLet = function (v) {
      if (v instanceof Data_List_Types.Cons && (v.value0 instanceof Types.MalList && (v.value1 instanceof Data_List_Types.Cons && v.value1.value1 instanceof Data_List_Types.Nil))) {
          return Env.local(Control_Apply.applySecond(Types.applyMalEnv)(letBind(v.value0.value0))($$eval(v.value1.value0)));
      };
  ...
  var evalIf = function (v) {
      if (v instanceof Data_List_Types.Cons && (v.value1 instanceof Data_List_Types.Cons && (v.value1.value1 instanceof Data_List_Types.Cons && v.value1.value1.value1 instanceof Data_List_Types.Nil))) {
          return Control_Bind.bind(Types.bindMalEnv)(evalAst(v.value0))(function (cond) {
      ...
      return Env.throwStr(Types.monadEffectMalEnv)("invalid if");
  };
  var evalFnMatch = function (v) {
      ...
      return Env.throwStr(Types.monadEffectMalEnv)("invalid fn*");
  };
  ...
  var evalFn = function (params) {
      return function (body) {
          var unwrapSymbol = function (v) {
              if (v instanceof Types.MalSymbol) {
                  return Control_Applicative.pure(Types.applicativeMalEnv)(v.value0);
              };
              return Env.throwStr(Types.monadEffectMalEnv)("fn* parameter must be symbols");
          };
          var fn = function (params$prime) {
              return function (body$prime) {
                  return function (args) {
                      return Env.local(Control_Bind.bind(Types.bindMalEnv)(Env.sets(params$prime)(args))(function (ok) {
                          if (ok) {
                              return evalAst(body$prime);
                          };
                          return Env.throwStr(Types.monadEffectMalEnv)("actual parameters do not match signature ");
                      }));
                  };
              };
          };
          return Control_Bind.bind(Types.bindMalEnv)(Data_Traversable.traverse(Data_List_Types.traversableList)(Types.applicativeMalEnv)(unwrapSymbol)(params))(function (paramsStr) {
              return Control_Applicative.pure(Types.applicativeMalEnv)(new Types.MalFunction({
  ...
  var evalDo = function (es) {
      return Data_List.foldM(Types.monadMalEnv)(Data_Function["const"](evalAst))(Types.MalNil.value)(es);
  };
  var evalDef = function (v) {
      if (v instanceof Data_List_Types.Cons && (v.value0 instanceof Types.MalSymbol && (v.value1 instanceof Data_List_Types.Cons && v.value1.value1 instanceof Data_List_Types.Nil))) {
          return Control_Bind.bind(Types.bindMalEnv)(evalAst(v.value1.value0))(function (evd) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Types.bindMalEnv)(Env.set(v.value0.value0)(evd))(function () {
                  return Control_Applicative.pure(Types.applicativeMalEnv)(evd);
              });
          });
      };
      return Env.throwStr(Types.monadEffectMalEnv)("invalid def!");
  };
  var evalAst = function (v) {
      if (v instanceof Types.MalSymbol) {
          return Control_Bind.bind(Types.bindMalEnv)(Control_Monad_Reader_Class.ask(Types.monadAskMalEnv))(function (ref) {
              return Control_Bind.bind(Types.bindMalEnv)(Effect_Class.liftEffect(Types.monadEffectMalEnv)(Effect_Ref.read(ref)))(function (envs) {
                  ...
                  if (v1 instanceof Data_Maybe.Nothing) {
                      return Env.throwStr(Types.monadEffectMalEnv)("'" + (v.value0 + ("'" + " not found")));
                  };
      ...
      if (v instanceof Types.MalVector) {
          return Data_Functor.map(Types.functorMalEnv)(Types.MalVector.create)(Data_Traversable.traverse(Data_List_Types.traversableList)(Types.applicativeMalEnv)($$eval)(v.value0));
      };
      if (v instanceof Types.MalHashMap) {
          return Data_Functor.map(Types.functorMalEnv)(Types.MalHashMap.create)(Data_Traversable.traverse(Data_Map_Internal.traversableMap)(Types.applicativeMalEnv)($$eval)(v.value0));
      };
      return Control_Applicative.pure(Types.applicativeMalEnv)(v);
  };
  ...
  var $$eval = function (v) {
      ...
      if (v instanceof Types.MalList) {
          ...
          return Control_Bind.bind(Types.bindMalEnv)(Data_Traversable.traverse(Data_List_Types.traversableList)(Types.applicativeMalEnv)(evalAst)(v.value0))(function (es) {
              if (es instanceof Data_List_Types.Cons && es.value0 instanceof Types.MalFunction) {
                  return es.value0.value0.fn(es.value1);
              };
              return Env.throwStr(Types.monadEffectMalEnv)("invalid function");
          });
      };
      return evalAst(v);
  };
  ...
  var rep = function (str) {
      var v = read(str);
      if (v instanceof Data_Either.Left) {
          return Env.throwStr(Types.monadEffectMalEnv)("EOF");
      };
      if (v instanceof Data_Either.Right) {
          return Data_Functor.map(Types.functorMalEnv)(print)($$eval(v.value0));
      };
      throw new Error("Failed pattern match at Main (line 140, column 11 - line 142, column 34): " + [ v.constructor.name ]);
  };
  var loop = Control_Bind.bind(Types.bindMalEnv)(Effect_Class.liftEffect(Types.monadEffectMalEnv)(Readline.readLine))(function (line) {
      if (line === ":q") {
          return Control_Applicative.pure(Types.applicativeMalEnv)(Data_Unit.unit);
      };
      return Control_Bind.bind(Types.bindMalEnv)(Control_Monad_Error_Class["try"](Types.monadErrorMalEnv)(rep(line)))(function (result) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Types.bindMalEnv)((function () {
              if (result instanceof Data_Either.Right) {
                  return Effect_Class.liftEffect(Types.monadEffectMalEnv)(Effect_Console.log(result.value0));
              };
              if (result instanceof Data_Either.Left) {
                  return Effect_Class.liftEffect(Types.monadEffectMalEnv)(Effect_Console.error(Data_Show.show(Effect_Exception.showError)(result.value0)));
              };
              throw new Error("Failed pattern match at Main (line 152, column 7 - line 154, column 51): " + [ result.constructor.name ]);
          })())(function () {
              return loop;
          });
      });
  ...
  var setEval = function (v) {
      ...
      return Env.throwStr(Types.monadEffectMalEnv)("illegal call of eval");
  };

  //
  var main = function __do() {
      var ref = Effect_Class.liftEffect(Effect_Class.monadEffectEffect)(Env.initEnvRef)();
      return Data_Function.flip(Env.runMalEnv)(ref)(Control_Apply.applySecond(Types.applyMalEnv)(Control_Apply.applySecond(Types.applyMalEnv)(Control_Apply.applySecond(Types.applyMalEnv)(Control_Apply.applySecond(Types.applyMalEnv)(Data_Traversable.traverse(Data_List_Types.traversableList)(Types.applicativeMalEnv)(setFn)(Core.ns))(setFn(new Data_Tuple.Tuple("eval", setEval))))(rep("(def! not (fn* (a) (if a false true)))")))(rep("(def! load-file (fn* (f) (eval (read-string (str \"(do \" (slurp f) \"\x0anil)\")))))")))(loop))();
  };
  exports["read"] = read;
  exports["eval"] = $$eval;
