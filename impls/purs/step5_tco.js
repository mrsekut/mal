...
(function($PS) {
  ...
  var Types = $PS["Types"];                
  var str = (function () {
      var $51 = Control_Applicative.pure(Types.applicativeMalEnv);
      var $52 = Printer.printListReadably("");
      return function ($53) {
          return $51(Types.MalString.create($52($53)));
      };
  })();
  ...
  var prStr = (function () {
      var $54 = Control_Applicative.pure(Types.applicativeMalEnv);
      return function ($55) {
          return $54(Types.MalString.create(Printer.printList($55)));
      };
  })();
  ...
  var list = (function () {
      var $56 = Control_Applicative.pure(Types.applicativeMalEnv);
      return function ($57) {
          return $56(Types.toList($57));
      };
  })();
  var eqQ = function (v) {
  ...
  var readSymbol = (function () {
      ...
      var f = function (first) {
          return function (rest) {
              return g(Types.charListToString(new Data_List_Types.Cons(first, rest)));
          };
      };
...
(function($PS) {
  ...
  var main = function __do() {
      ...
      return Data_Function.flip(Env.runMalEnv)(ref)(Control_Apply.applySecond(Types.applyMalEnv)(Control_Apply.applySecond(Types.applyMalEnv)(Data_Traversable.traverse(Data_List_Types.traversableList)(Types.applicativeMalEnv)(setFn)(Core.ns))(rep("(def! not (fn* (a) (if a false true)))")))(loop))();
  };
  exports["read"] = read;
  exports["eval"] = $$eval;
