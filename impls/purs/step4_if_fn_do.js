...
(function($PS) {
  ...
  var set = function (v) {
      return function (v1) {
          return function (v2) {
              ...
              throw new Error("Failed pattern match at Env (line 74, column 1 - line 74, column 50): " + [ v.constructor.name, v1.constructor.name, v2.constructor.name ]);
          };
      };
  };
  var sets = function (env) {
      return function (v) {
          return function (v1) {
              ...
              if (v instanceof Data_List_Types.Cons && (v.value0 === "&" && (v.value1 instanceof Data_List_Types.Cons && v.value1.value1 instanceof Data_List_Types.Nil))) {
                  return Control_Apply.applySecond(Effect.applyEffect)(set(env)(v.value1.value0)(Types.toList(v1)))(Control_Applicative.pure(Effect.applicativeEffect)(true));
              };
              if (v instanceof Data_List_Types.Cons && v1 instanceof Data_List_Types.Cons) {
                  return Control_Apply.applySecond(Effect.applyEffect)(set(env)(v.value0)(v1.value0))(sets(env)(v.value1)(v1.value1));
              };
  ...
  var newEnv = function (re) {
      return function __do() {
          var a = Effect_Ref["new"](initEnv)();
          return new Data_List_Types.Cons(a, re);
      };
  };
  ...
  var get = function (v) {
      return function (v1) {
          ...
          throw new Error("Failed pattern match at Env (line 58, column 1 - line 58, column 50): " + [ v.constructor.name, v1.constructor.name ]);
      };
  };
...
(function($PS) {
      ...
      return function (v1) {
          if (v1 instanceof Types.MalSymbol) {
              return function __do() {
                  ...
                  throw new Error("Failed pattern match at Main (line 54, column 3 - line 56, column 55): " + [ result.constructor.name ]);
              };
          };
  ...
  var rep = function (env) {
      return function (str) {
          ...
          throw new Error("Failed pattern match at Main (line 147, column 15 - line 149, column 38): " + [ v.constructor.name ]);
      };
  };
  var loop = function (env) {
      return function __do() {
          ...
          (function () {
              ...
              throw new Error("Failed pattern match at Main (line 159, column 7 - line 161, column 38): " + [ result.constructor.name ]);
          })();
          return loop(env)();
      };
  };
