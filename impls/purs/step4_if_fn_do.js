...
(function($PS) {
  ...
  var ordKey = new Data_Ord.Ord(function () {
      ...
      return function (y) {
          ...
          throw new Error("Failed pattern match at Types (line 48, column 1 - line 48, column 34): " + [ x.constructor.name, y.constructor.name ]);
      };
  });
  var listToMap = Data_Map_Internal.fromFoldable(ordKey)(Data_List_Types.foldableList);
  var charListToString = (function () {
      var $56 = Data_Array.fromFoldable(Data_List_Types.foldableList);
      return function ($57) {
          return Data_String_CodeUnits.fromCharArray($56($57));
      };
  })();
...
(function($PS) {
  ...
  var printStr = function (v) {
      ...
      throw new Error("Failed pattern match at Printer (line 12, column 1 - line 12, column 30): " + [ v.constructor.name ]);
  };
  var printList = function (v) {
      ...
      throw new Error("Failed pattern match at Printer (line 25, column 1 - line 25, column 36): " + [ v.constructor.name ]);
  };
...
(function($PS) {
  ...
  var nonEscape = Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_String.noneOf(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)([ "\"", "\\" ]))(function (n) {
      return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(new Data_List_Types.Cons(n, Data_List_Types.Nil.value));
  });
  ...
  var readNegativeNumber = Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))((function () {
      var $14 = Data_Ring.negate(Data_Ring.ringInt);
      return function ($15) {
          return Types.MalInt.create($14($15));
      };
  ...
  var $$escape = Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_String["char"](Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("\\"))(function (b) {
      return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_String.oneOf(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)([ "\"", "\\", "n" ]))(function (c) {
          return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(new Data_List_Types.Cons(b, new Data_List_Types.Cons(c, Data_List_Types.Nil.value)));
      });
  });
  var readString = Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(function ($16) {
      return Types.MalString.create(Types.charListToString($16));
  })(Control_Apply.applyFirst(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_String["char"](Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("\""))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_List.concat)(Data_List.many(Text_Parsing_Parser.alternativeParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser.lazyParserT)(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))($$escape)(nonEscape)))))(Text_Parsing_Parser_String["char"](Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("\"")));
  ...
  var readHashMap = (function () {
      var g = function (v) {
          if (v instanceof Data_Maybe.Just) {
              return Types.MalHashMap.create(Types.listToMap(v.value0));
          };
          if (v instanceof Data_Maybe.Nothing) {
              return new Types.MalString("hash map error");
          };
          throw new Error("Failed pattern match at Mal.Reader (line 125, column 3 - line 125, column 51): " + [ v.constructor.name ]);
      };
  ...
  var readStr = function (str) {
      ...
      throw new Error("Failed pattern match at Mal.Reader (line 176, column 15 - line 178, column 25): " + [ v.constructor.name ]);
  };
