...
(function($PS) {
  ...
  var ordKey = new Data_Ord.Ord(function () {
      ...
      return function (y) {
          ...
          throw new Error("Failed pattern match at Types (line 36, column 1 - line 36, column 34): " + [ x.constructor.name, y.constructor.name ]);
      };
  });
  var listToMap = Data_Map_Internal.fromFoldable(ordKey)(Data_List_Types.foldableList);
  var charListToString = (function () {
      var $38 = Data_Array.fromFoldable(Data_List_Types.foldableList);
      return function ($39) {
          return Data_String_CodeUnits.fromCharArray($38($39));
      };
  })();
...
(function($PS) {
  ...
  var setArithOp = (function () {
      var fn = function (op) {
          ...
          return Types.MalFunction.create({
              fn: g(op),
              params: Data_List_Types.Nil.value
          });
      };
      return Control_Bind.discard(Control_Bind.discardUnit)(Types.bindMalEnv)(Env.set("+")(fn(Data_Semiring.add(Data_Semiring.semiringInt))))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(Types.bindMalEnv)(Env.set("-")(fn(Data_Ring.sub(Data_Ring.ringInt))))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(Types.bindMalEnv)(Env.set("*")(fn(Data_Semiring.mul(Data_Semiring.semiringInt))))(function () {
      ...
      if (v instanceof Types.MalSymbol) {
          return Control_Bind.bind(Types.bindMalEnv)(Control_Monad_Reader_Class.ask(Types.monadAskMalEnv))(function (ref) {
              return Control_Bind.bind(Types.bindMalEnv)(Effect_Class.liftEffect(Types.monadEffectMalEnv)(Effect_Ref.read(ref)))(function (envs) {
                  ...
                  throw new Error("Failed pattern match at Main (line 53, column 3 - line 55, column 58): " + [ v1.constructor.name ]);
              });
          });
      };
      if (v instanceof Types.MalList) {
  ...
  var rep = function (str) {
      ...
      throw new Error("Failed pattern match at Main (line 133, column 11 - line 135, column 34): " + [ v.constructor.name ]);
  };
  var loop = Control_Bind.bind(Types.bindMalEnv)(Effect_Class.liftEffect(Types.monadEffectMalEnv)(Readline.readLine))(function (line) {
      ...
      return Control_Bind.bind(Types.bindMalEnv)(Control_Monad_Error_Class["try"](Types.monadErrorMalEnv)(rep(line)))(function (result) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Types.bindMalEnv)((function () {
              ...
              throw new Error("Failed pattern match at Main (line 145, column 7 - line 147, column 51): " + [ result.constructor.name ]);
          })())(function () {
              return loop;
          });
      });
  ...
  var main = function __do() {
      ...
      return Data_Function.flip(Env.runMalEnv)(ref)(Control_Bind.discard(Control_Bind.discardUnit)(Types.bindMalEnv)(setArithOp)(function () {
          return loop;
      }))();
  };
  exports["read"] = read;
