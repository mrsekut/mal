...
(function($PS) {
  ...
  var get = function (ky) {
      return function (envs) {
          ...
          throw new Error("Failed pattern match at Env (line 77, column 15 - line 79, column 23): " + [ v.constructor.name ]);
      };
  };
...
(function($PS) {
  ...
  var ordKey = new Data_Ord.Ord(function () {
      ...
      return function (y) {
          ...
          throw new Error("Failed pattern match at Types (line 30, column 1 - line 30, column 34): " + [ x.constructor.name, y.constructor.name ]);
      };
  });
...
(function($PS) {
  ...
  var throwStr = function (dictMonadEffect) {
      var $89 = Effect_Class.liftEffect(dictMonadEffect);
      return function ($90) {
          return $89(Effect_Exception["throw"]($90));
      };
  };
  ...
  var letBind = function (v) {
      ...
      if (v instanceof Data_List_Types.Cons && (v.value0 instanceof Types.MalSymbol && v.value1 instanceof Data_List_Types.Cons)) {
          return Control_Apply.applySecond(Env.applyMalEnv)(Control_Bind.bindFlipped(Env.bindMalEnv)(Env.set(v.value0.value0))($$eval(v.value1.value0)))(letBind(v.value1.value1));
      };
      return throwStr(Env.monadEffectMalEnv)("invalid let*");
  };
  var evalLet = function (v) {
      if (v instanceof Data_List_Types.Cons && (v.value0 instanceof Types.MalList && (v.value1 instanceof Data_List_Types.Cons && v.value1.value1 instanceof Data_List_Types.Nil))) {
          return Env.local(Control_Apply.applySecond(Env.applyMalEnv)(letBind(v.value0.value0))($$eval(v.value1.value0)));
      };
  ...
  var evalIf = function (v) {
      if (v instanceof Data_List_Types.Cons && (v.value1 instanceof Data_List_Types.Cons && (v.value1.value1 instanceof Data_List_Types.Cons && v.value1.value1.value1 instanceof Data_List_Types.Nil))) {
          return Control_Bind.bind(Env.bindMalEnv)(evalAst(v.value0))(function (cond) {
      ...
      return throwStr(Env.monadEffectMalEnv)("invalid if");
  };
  var evalDef = function (v) {
      if (v instanceof Data_List_Types.Cons && (v.value0 instanceof Types.MalSymbol && (v.value1 instanceof Data_List_Types.Cons && v.value1.value1 instanceof Data_List_Types.Nil))) {
          return Control_Bind.bind(Env.bindMalEnv)(evalAst(v.value1.value0))(function (evd) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Env.bindMalEnv)(Env.set(v.value0.value0)(evd))(function () {
                  return Control_Applicative.pure(Env.applicativeMalEnv)(evd);
              });
          });
      };
      return throwStr(Env.monadEffectMalEnv)("invalid def!");
  };
  var evalAst = function (v) {
          ...
          return Control_Bind.bind(Env.bindMalEnv)(Control_Monad_Reader_Class.ask(Env.monadAskMalEnv))(function (ref) {
              return Control_Bind.bind(Env.bindMalEnv)(Effect_Class.liftEffect(Env.monadEffectMalEnv)(Effect_Ref.read(ref)))(function (envs) {
                  ...
                  if (v1 instanceof Data_Maybe.Nothing) {
                      return throwStr(Env.monadEffectMalEnv)("'" + (v.value0 + ("'" + " not found")));
                  };
                  throw new Error("Failed pattern match at Main (line 54, column 3 - line 56, column 58): " + [ v1.constructor.name ]);
              });
          });
      };
      if (v instanceof Types.MalList) {
      ...
      if (v instanceof Types.MalVector) {
          return Data_Functor.map(Env.functorMalEnv)(Types.MalVector.create)(Data_Traversable.traverse(Data_List_Types.traversableList)(Env.applicativeMalEnv)($$eval)(v.value0));
      };
      if (v instanceof Types.MalHashMap) {
          return Data_Functor.map(Env.functorMalEnv)(Types.MalHashMap.create)(Data_Traversable.traverse(Data_Map_Internal.traversableMap)(Env.applicativeMalEnv)($$eval)(v.value0));
      };
  ...
  var $$eval = function (v) {
      ...
      if (v instanceof Types.MalList) {
          ...
          return Control_Bind.bind(Env.bindMalEnv)(Data_Traversable.traverse(Data_List_Types.traversableList)(Env.applicativeMalEnv)(evalAst)(v.value0))(function (es) {
              ...
              return throwStr(Env.monadEffectMalEnv)("invalid function");
          });
      };
      return evalAst(v);
  };
  ...
  var rep = function (str) {
      var v = read(str);
      if (v instanceof Data_Either.Left) {
          return throwStr(Env.monadEffectMalEnv)("EOF");
      };
      if (v instanceof Data_Either.Right) {
          return Data_Functor.map(Env.functorMalEnv)(print)($$eval(v.value0));
      };
      throw new Error("Failed pattern match at Main (line 112, column 11 - line 114, column 34): " + [ v.constructor.name ]);
  };
  var loop = Control_Bind.bind(Env.bindMalEnv)(Effect_Class.liftEffect(Env.monadEffectMalEnv)(Readline.readLine))(function (line) {
      if (line === ":q") {
          return Control_Applicative.pure(Env.applicativeMalEnv)(Data_Unit.unit);
      };
      return Control_Bind.bind(Env.bindMalEnv)(Control_Monad_Error_Class["try"](Env.monadErrorMalEnv)(rep(line)))(function (result) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Env.bindMalEnv)((function () {
              if (result instanceof Data_Either.Right) {
                  return Effect_Class.liftEffect(Env.monadEffectMalEnv)(Effect_Console.log(result.value0));
              };
              ...
              throw new Error("Failed pattern match at Main (line 124, column 7 - line 126, column 51): " + [ result.constructor.name ]);
          })())(function () {
              return loop;
          });
      });
