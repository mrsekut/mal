...
(function($PS) {
  ...
  var stringToCharList = (function () {
      var $56 = Data_List.fromFoldable(Data_Foldable.foldableArray);
      return function ($57) {
          return $56(Data_String_CodeUnits.toCharArray($57));
      };
  })();                                                                                                           
  ...
  var ordKey = new Data_Ord.Ord(function () {
      ...
      return function (y) {
          ...
          throw new Error("Failed pattern match at Types (line 51, column 1 - line 51, column 34): " + [ x.constructor.name, y.constructor.name ]);
      };
  });
  var listToMap = Data_Map_Internal.fromFoldable(ordKey)(Data_List_Types.foldableList);
  var charListToString = (function () {
      var $58 = Data_Array.fromFoldable(Data_List_Types.foldableList);
      return function ($59) {
          return Data_String_CodeUnits.fromCharArray($58($59));
      };
  })();
...
(function($PS) {
  ...
  var throwStr = function (dictMonadEffect) {
      ...
      return function ($32) {
          return $31(Effect_Exception["throw"]($32));
      };
  };
  var set = function (ky) {
      return function (ex) {
          var update = function (v) {
              return function (v1) {
                  return function (v2) {
                      ...
                      throw new Error("Failed pattern match at Env (line 84, column 3 - line 84, column 54): " + [ v.constructor.name, v1.constructor.name, v2.constructor.name ]);
                  };
              };
          };
          return Control_Bind.bind(Types.bindMalEnv)(Control_Monad_Reader_Class.ask(Types.monadAskMalEnv))(function (ref) {
              return Control_Bind.bind(Types.bindMalEnv)(Effect_Class.liftEffect(Types.monadEffectMalEnv)(Effect_Ref.read(ref)))(function (env) {
                  return Effect_Class.liftEffect(Types.monadEffectMalEnv)(Effect_Ref.write(update(ky)(ex)(env))(ref));
              });
          });
      };
  };
...
(function($PS) {
  ...
  var printStr = function (v) {
      ...
      throw new Error("Failed pattern match at Printer (line 13, column 1 - line 13, column 30): " + [ v.constructor.name ]);
  };
  var printList = function (v) {
      ...
      throw new Error("Failed pattern match at Printer (line 49, column 1 - line 49, column 36): " + [ v.constructor.name ]);
  };
  ...
  var pp = function (v) {
      ...
      if (v instanceof Types.MalHashMap) {
          return "{" + (epl(" ")(Types.flatTuples(Data_Map_Internal.toUnfoldable(Data_List_Types.unfoldableList)(v.value0))) + "}");
      };
      return printStr(v);
  };
  var epl = function (v) {
      return function (v1) {
          ...
          if (v1 instanceof Data_List_Types.Cons) {
              return pp(v1.value0) + (v + epl(v)(v1.value1));
          };
          throw new Error("Failed pattern match at Printer (line 36, column 1 - line 36, column 41): " + [ v.constructor.name, v1.constructor.name ]);
      };
  };
...
(function($PS) {
  ...
  var Types = $PS["Types"];                
  var str = (function () {
      var $47 = Control_Applicative.pure(Types.applicativeMalEnv);
      var $48 = Printer.epl("");
      return function ($49) {
          return $47(Types.MalString.create($48($49)));
      };
  })();
  ...
  var println = function (args) {
      return Effect_Class.liftEffect(Types.monadEffectMalEnv)(function __do() {
          Effect_Console.log(Printer.epl(" ")(args))();
          return Types.MalNil.value;
      });
  };
  var prStr = (function () {
      var $50 = Control_Applicative.pure(Types.applicativeMalEnv);
      return function ($51) {
          return $50(Types.MalString.create(Printer.printList($51)));
      };
  })();
  ...
  // List functions
  var list = (function () {
      var $52 = Control_Applicative.pure(Types.applicativeMalEnv);
      return function ($53) {
          return $52(Types.toList($53));
      };
  })();
...
(function($PS) {
  ...
  var evalFn = function (v) {
      if (v instanceof Data_List_Types.Cons && (v.value0 instanceof Types.MalList && (v.value1 instanceof Data_List_Types.Cons && v.value1.value1 instanceof Data_List_Types.Nil))) {
          ...
          return Control_Bind.bind(Types.bindMalEnv)(Data_Traversable.traverse(Data_List_Types.traversableList)(Types.applicativeMalEnv)(unwrapSymbol)(v.value0.value0))(function (strParams) {
              return Control_Applicative.pure(Types.applicativeMalEnv)(new Types.MalFunction({
                  fn: fn(strParams)(v.value1.value0),
                  params: strParams
              }));
          });
      };
  ...
  var rep = function (str) {
      ...
      throw new Error("Failed pattern match at Main (line 135, column 11 - line 137, column 34): " + [ v.constructor.name ]);
  };
  var loop = Control_Bind.bind(Types.bindMalEnv)(Effect_Class.liftEffect(Types.monadEffectMalEnv)(Readline.readLine))(function (line) {
      ...
      return Control_Bind.bind(Types.bindMalEnv)(Control_Monad_Error_Class["try"](Types.monadErrorMalEnv)(rep(line)))(function (result) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Types.bindMalEnv)((function () {
              ...
              throw new Error("Failed pattern match at Main (line 147, column 7 - line 149, column 51): " + [ result.constructor.name ]);
          })())(function () {
              return loop;
          });
      });
  ...
  exports["unwrapSymbol"] = unwrapSymbol;
  exports["print"] = print;
  exports["rep"] = rep;
  exports["loop"] = loop;
  exports["setFn"] = setFn;
