...
(function($PS) {
  ...
  var stringToCharList = (function () {
      var $65 = Data_List.fromFoldable(Data_Foldable.foldableArray);
      return function ($66) {
          return $65(Data_String_CodeUnits.toCharArray($66));
      };
  })();
  ...
  var charListToString = (function () {
      var $67 = Data_Array.fromFoldable(Data_List_Types.foldableList);
      return function ($68) {
          return Data_String_CodeUnits.fromCharArray($67($68));
      };
  })();
  ...
  var $dollar_OrdKey_17 = new Data_Ord.Ord(function () {
      ...
      return function (y) {
          ...
          throw new Error("Failed pattern match at Types (line 52, column 1 - line 52, column 24): " + [ x.constructor.name, y.constructor.name ]);
      };
  });
...
(function($PS) {
  ...
  var readString = function (v) {
      if (v instanceof Data_List_Types.Cons && (v.value0 instanceof Types.MalString && v.value1 instanceof Data_List_Types.Nil)) {
          ...
          throw new Error("Failed pattern match at Core (line 118, column 34 - line 120, column 25): " + [ v1.constructor.name ]);
      };
      return Effect_Exception["throw"]("invalid read-string");
  };
  ...
  var list = (function () {
      var $105 = Control_Applicative.pure(Effect.applicativeEffect);
      return function ($106) {
          return $105(Types.toList($106));
      };
  })();
  var eqQ = function (v) {
  ...
  var do_concat = function (args) {
      return Data_Functor.map(Effect.functorEffect)(function ($107) {
          return Types.toList(Data_List.concat($107));
  ...
  var cons = function (v) {
      ...
      if (v instanceof Data_List_Types.Cons && (v.value1 instanceof Data_List_Types.Cons && (v.value1.value0 instanceof Types.MalList && v.value1.value1 instanceof Data_List_Types.Nil))) {
          return Control_Applicative.pure(Effect.applicativeEffect)(Types.toList(new Data_List_Types.Cons(v.value0, v.value1.value0.value0)));
      };
      ...
      return function (v1) {
          if (v1 instanceof Types.MalSymbol) {
              return function __do() {
                  ...
                  throw new Error("Failed pattern match at Main (line 101, column 3 - line 103, column 55): " + [ result.constructor.name ]);
              };
          };
