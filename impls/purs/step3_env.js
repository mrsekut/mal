  ...
  var set = function (v) {
      return function (v1) {
          return function (v2) {
              ...
              throw new Error("Failed pattern match at Env (line 81, column 1 - line 81, column 50): " + [ v.constructor.name, v1.constructor.name, v2.constructor.name ]);
          };
      };
  };
...
(function($PS) {
      ...
      return function (v1) {
          if (v1 instanceof Types.MalSymbol) {
              return function __do() {
                  ...
                  throw new Error("Failed pattern match at Main (line 46, column 3 - line 48, column 55): " + [ result.constructor.name ]);
              };
          };
  ...
  var rep = function (env) {
      return function (str) {
          ...
          throw new Error("Failed pattern match at Main (line 94, column 15 - line 96, column 38): " + [ v.constructor.name ]);
      };
  };
  var loop = function (env) {
      return function __do() {
          ...
          (function () {
              ...
              throw new Error("Failed pattern match at Main (line 106, column 7 - line 108, column 38): " + [ result.constructor.name ]);
          })();
          return loop(env)();
      };
  };
