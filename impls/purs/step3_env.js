...
(function($PS) {
              ...
              var update = function (v) {
                  return function (v1) {
                      return function (v2) {
                          ...
                          throw new Error("Failed pattern match at Env (line 84, column 3 - line 84, column 58): " + [ v.constructor.name, v1.constructor.name, v2.constructor.name ]);
                      };
                  };
              };
              return function __do() {
                  var envs = Effect_Ref.read(re)();
                  return Effect_Ref.write(update(ky)(ex)(envs))(re)();
              };
          };
      };
  };
  ...
  var newEnv = function (re) {
      return function __do() {
          var envs = Effect_Ref.read(re)();
          Effect_Ref.write(new Data_List_Types.Cons(initEnv, envs))(re)();
          return re;
      };
  };
  var get = function (re) {
      return function (ky) {
          var find = function ($copy_v) {
              return function ($copy_v1) {
                  ...
                  function $tco_loop(v, v1) {
                      ...
                      throw new Error("Failed pattern match at Env (line 64, column 3 - line 64, column 46): " + [ v.constructor.name, v1.constructor.name ]);
                  };
                  while (!$tco_done) {
          ...
          return function __do() {
              ...
              throw new Error("Failed pattern match at Env (line 59, column 3 - line 61, column 28): " + [ v.constructor.name ]);
          };
      };
  };
...
(function($PS) {
  ...
  var main = function __do() {
      var re = Control_Bind.bindFlipped(Effect.bindEffect)(Env.newEnv)(Env.initEnvRef)();
      setArithOp(re)();
      return loop(re)();
  };
  exports["read"] = read;
