...
(function($PS) {
  ...
  var update = function (v) {
      return function (v1) {
          return function (v2) {
              ...
              throw new Error("Failed pattern match at Env (line 48, column 1 - line 48, column 52): " + [ v.constructor.name, v1.constructor.name, v2.constructor.name ]);
          };
      };
  };
  ...
  var find = function ($copy_v) {
      return function ($copy_v1) {
          ...
          function $tco_loop(v, v1) {
              ...
              if (v1 instanceof Data_List_Types.Cons) {
                  var $15 = Data_Map_Internal.member(Data_Ord.ordString)(v)(v1.value0);
                  if ($15) {
                      $tco_done = true;
              ...
              throw new Error("Failed pattern match at Env (line 33, column 1 - line 33, column 40): " + [ v.constructor.name, v1.constructor.name ]);
          };
          while (!$tco_done) {
  ...
  var get = function (k) {
      return function (es) {
          ...
          throw new Error("Failed pattern match at Env (line 28, column 12 - line 30, column 23): " + [ v.constructor.name ]);
      };
  };
  var bindMalEnv = Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect);

  // setE :: Env -> String -> MalExpr -> MalEnv Unit
  // setE = ?s
...
(function($PS) {
  ...
  var printList = function (v) {
      ...
      throw new Error("Failed pattern match at Printer (line 24, column 1 - line 24, column 36): " + [ v.constructor.name ]);
  };
...
(function($PS) {
      ...
      if (v instanceof Data_List_Types.Cons && (v.value0 instanceof Types.MalSymbol && (v.value0.value0 === "let*" && (v.value1 instanceof Data_List_Types.Cons && (v.value1.value0 instanceof Types.MalList && (v.value1.value1 instanceof Data_List_Types.Cons && v.value1.value1.value1 instanceof Data_List_Types.Nil)))))) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Env.bindMalEnv)(Env.newEnv)(function () {
              return Control_Bind.bind(Env.bindMalEnv)(letBind(v.value1.value0.value0))(function () {
                  return $$eval(v.value1.value1.value0);
              });
          });
      };
          ...
          return Control_Bind.bind(Env.bindMalEnv)(Control_Monad_Reader_Class.ask(Env.monadAskMalEnv))(function (ref) {
              return Control_Bind.bind(Env.bindMalEnv)(Effect_Class.liftEffect(Env.monadEffectMalEnv)(Effect_Ref.read(ref)))(function (es) {
                  ...
                  if (v1 instanceof Data_Maybe.Nothing) {
                      return Effect_Class.liftEffect(Env.monadEffectMalEnv)(Effect_Exception["throw"](v.value0 + " is not found"));
                  };
                  throw new Error("Failed pattern match at Main (line 52, column 3 - line 54, column 57): " + [ v1.constructor.name ]);
              });
          });
      };
      if (v instanceof Types.MalList) {
  ...
  var rep = function (str) {
      ...
      throw new Error("Failed pattern match at Main (line 102, column 11 - line 106, column 24): " + [ v.constructor.name ]);
  };
  var loop = Control_Bind.bind(Env.bindMalEnv)(Effect_Class.liftEffect(Env.monadEffectMalEnv)(Readline.readLine))(function (line) {
      if (line === ":q") {
          return Control_Applicative.pure(Env.applicativeMalEnv)(Data_Unit.unit);
      };
      return Control_Bind.bind(Env.bindMalEnv)(rep(line))(function (result) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Env.bindMalEnv)(Effect_Class.liftEffect(Env.monadEffectMalEnv)(Effect_Console.log(result)))(function () {
              return loop;
          });
      });
  });
