...
(function($PS) {
  ...
  var rep = function (str) {
      ...
      throw new Error("Failed pattern match at Main (line 91, column 11 - line 93, column 34): " + [ v.constructor.name ]);
  };
  var loop = Control_Bind.bind(Env.bindMalEnv)(Effect_Class.liftEffect(Env.monadEffectMalEnv)(Readline.readLine))(function (line) {
      ...
      return Control_Bind.bind(Env.bindMalEnv)(Control_Monad_Error_Class["try"](Env.monadErrorMalEnv)(rep(line)))(function (result) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Env.bindMalEnv)((function () {
              ...
              throw new Error("Failed pattern match at Main (line 103, column 7 - line 105, column 51): " + [ result.constructor.name ]);
          })())(function () {
              return loop;
          });
      });
