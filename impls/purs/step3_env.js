...
(function($PS) {
  "use strict";
  $PS["Mal.Step3"] = $PS["Mal.Step3"] || {};
  var exports = $PS["Mal.Step3"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_Error_Class = $PS["Control.Monad.Error.Class"];
  var Data_Either = $PS["Data.Either"];
  ...
  var setArithOp = function (env) {
      return function __do() {
          Env.set(env)("+")(fn(Data_Semiring.add(Data_Semiring.semiringInt)))();
          Env.set(env)("-")(fn(Data_Ring.sub(Data_Ring.ringInt)))();
          Env.set(env)("*")(fn(Data_Semiring.mul(Data_Semiring.semiringInt)))();
          return Env.set(env)("/")(fn(Data_EuclideanRing.div(Data_EuclideanRing.euclideanRingInt)))();
      };
  };
      ...
      return function (v1) {
          if (v1 instanceof Types.MalSymbol) {
              return function __do() {
                  ...
                  throw new Error("Failed pattern match at Mal.Step3 (line 46, column 3 - line 48, column 55): " + [ result.constructor.name ]);
              };
          };
  ...
  var rep = function (env) {
      return function (str) {
          ...
          throw new Error("Failed pattern match at Mal.Step3 (line 94, column 15 - line 96, column 38): " + [ v.constructor.name ]);
      };
  };
  var loop = function (env) {
      return function __do() {
          ...
          (function () {
              ...
              throw new Error("Failed pattern match at Mal.Step3 (line 106, column 7 - line 108, column 38): " + [ result.constructor.name ]);
          })();
          return loop(env)();
      };
  };
